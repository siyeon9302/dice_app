...
import com.siyeon.dice_app.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.diceStatBtn.setOnClickListener {
            Toast.makeText(this, "주사위 Go!", Toast.LENGTH_LONG).show()

            Log.d("MaindActivity", Random.nextInt(1,6).toString())
            Log.d("MaindActivity", Random.nextInt(1,6).toString())
